  ...
  return (
    <header class="header">
      <div class="header-content">
        ...
        <a
          href="https://github.com/kahboom/sigstore-playground"
          target="_blank"
