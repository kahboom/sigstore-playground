...
export const Header: Component<HeaderProps> = (props) => {
  return (
    <header class="header">
      ...
      <a href="https://github.com/kahboom/sigstore-playground" class="github-corner" aria-label="View source on GitHub" target="_blank" rel="noopener noreferrer">
